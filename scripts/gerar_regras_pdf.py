...
def gerar_pdf(slug, titulo, intro, especificas, prazo_extra="", prazo_box=None):
    ...
    if prazo_box:
        ...
        story.append(deadline_box(
            f"Prazo Fase 1 — Resumo + Vídeo · até <font color='#9A7D14'>25 de junho de 2026</font> · 23h59 (Brasília)"
    ...
    cron = [
        ("Fase 1 · Resumo + vídeo", "até 25/06/2026 · 23h59 (Brasília)"),
    ...
    story.append(Paragraph(
        ...
        "(envio também por <b>submissoes@encontrogeig.org</b>): "
        "<b>https://www.even3.com.br/1-encontro-de-governanca-estrategia-e-inovacao-governamental-722003/</b>. "
        "Dúvidas gerais: <b>contato@encontrogeig.org</b> · Comissão científica: <b>comissao.cientifica@encontrogeig.org</b>.", P))
