...
> **Realização:** UFF · ABAR · PPGEP - LabDGE/UFF · GIGS/UNICAMP
> **Parceiros (aguardando confirmação — ocultos no site):** Firjan · IBP · ANP · AGENERSA · Fecomércio · CAU/RJ · CREA-RJ · LabDGE/UFF
...
| Data | Marco |
|---|---|
| **16/06/2026 23h59** | Prazo Fase 1 (resumo + vídeo) |
| **22/06/2026** | Resultado da avaliação |
